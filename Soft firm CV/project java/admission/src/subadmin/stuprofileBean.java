...
public class stuprofileBean {
	...
	int serial,capacity,id,roll;
	String center,address,room,usertrxid,date;
	...
	public stuprofileBean(int id , String name ,String fathername , String mothername , String dateofbirth, String mobile, String quota, String unit, String sscroll, String sscreg,
